...
public class HistoryService {
     ...
     */
    public List<HistoryDTO> getHistory(String userId, Pageable pageable) {
        List<HistoryDTO> result = new ArrayList<>();
        // userID에 해당하는 Survey를 Page크기만큼 가져오기
        Page<Survey> surveyPage = surveyRepository.findSurveyByUserId(Long.parseLong(userId), pageable);
